...
const sampleProjects = [
    ...
    details: {
      ...
      heroInfo: [
          ...
          },
          {
            ...
            numberOfMonths: 5,
            title: 'MONTHS',
            subtitle: 'The total duration of the development timeline was 5 months.',
        }
      ],
      overviewParagraphs: [
...

  {
    ...
    details: {
      ...
      keyFeature: {
        description: "We devised a method that incorporates every feature needed in a Charge OnSite app. Users can use this app on both mobile and desktop devices. Electric vehicle (EV) owners and building managers can use this app to access EV charging facilities.",
        keyFeaturesPoints1: [
      ...
      result: {
        description: "We made this app so that the charging station and the app can communicate without hiccups. The app has a lightning-fast connection time, allowing users to link up with a power source in a flash.",
        resultsPoints1: [
...

  {
    ...
    slug: 'breaking-mars',
    imageSrc: '/uploads/linkdinauto.png',
    details: {
      ...
      solution: {
        description: "Our team offered a more convenient, structured, and scalable LinkedIn-managed service. One can generate more campaigns for their clients on breaking Mars. It helps users find and close new customers from any corner of LinkedIn. Customers can get the highest number of leads within a fraction of a second. Here is an example of how simply this powerful tool works :",
        solutionsPoints1: [
      ...
      keyFeature: {
        description: "Our team has made the task much easier by automating functions like sending customized messages, connection requests, automated messages, and follow-ups.",
        keyFeaturesPoints1: [
    ...
    details: {
          ...
          heroInfo: [
              ...
              },
              {
                ...
                numberOfMonths: 14,
                title: 'MONTHS',
                subtitle: 'The total duration of the development timeline was 14 months.',
            }
          ],
          overviewParagraphs: [
          ...
          solution: {
            description: "The solution is to create a unified, multi-purpose application that can assist project managers and other stakeholders in cutting redundancy, streamlining processes, and improving overall efficiency. In particular, we aimed to furnish the user with the following amenities:",
            solutionsPoints1: [
          ...
          keyFeature: {
            description: "Our professional staff is dedicated to creating a reliable, user-friendly, and trustworthy platform. We’ve developed an industry-leading tool that speeds up project processing and streamlines the procedures.",
            keyFeaturesPoints1: [
          ...
          result: {
            description: "Our management team offers a befitting tool that is a vital bridge between a project manager and the team. Itcan provides a complete suite of social collaboration, communication, and management tools for a unit.",
            resultsPoints1: [
  ...
  },
  {
    ...
    details: {
      ...
      solution: {
        description: "We designed this marketplace to be adaptable and versatile for all users. Admin can quickly create an account, manage user accounts and transactions, examine the user’s vault and transaction history, view invoices, and monitor transactions. With the creation of this platform, we aim to convey the ease, swiftness, and sophistication of current internet-based buying. Our team of developers thoroughly comprehended the client’s goals, and after examining all of these factors, they provided the client with a solution that perfectly met their specifications.",
  ...
  },
  {
    ...
    details: {
      ...
      keyFeature: {
        description: "Our professional team streamlines their workflow and makes their project user-friendly and accessible to all users. We have provided the ideal solutions to their requirements.",
        keyFeaturesPoints1: [
      ...
      result: {
        description:"A kinetic marketplace is a valuable and authentic marketplace built to serve potential buyers and sellers. It is the ideal platform for businesspeople and merchants to build their online businesses. Users can benefit from an interface that is user-friendly, readily available, and simple to use for the optimum user experience.",
        resultsPoints1: [
  ...
  },
  {
    ...
    details: {
      ...
      regularTitle: 'Reliable Tool For Scheduling Messages And Automatic Future Delivery',
      heroInfo: [
          {
            icon: '/uploads/users.svg',
            alt: 'Developers',
          ...
          },
          {
            ...
            numberOfMonths: 4.5,
            title: 'MONTHS',
            subtitle: 'The total duration of the development timeline was 4.5 months.',
        }
      ],
      overviewParagraphs: [
      ...
      result: {
        description:"Forget Me Not is an innovative tool for expressing love and concern to those who matter most in one’s life.",
        resultsPoints1: [
  ...
  },
  {
    ...
    "This sustainable app helps users to track their funds, incomes, and expenditures. This app assists fund holders in monitoring their funding, budget making, and appointments. Plan managers can safely make and store the invoices in the app to fund their future expenditures and savings."],
      ...
      solution: {
        description: "Our focus with a solution was to give users full customization to make a budget and provide efficient information regarding their finances on the home screen so that they can save time knowing their financial situation.",
        solutionsPoints1: [
      ...
      keyFeature: {
        description: "Munca Mobile App is a robust plan management app that allows users to create and customize their budgets and track their funds and expenditures.",
        keyFeaturesPoints1: [
      ...
      result: {
        description:"Our experienced and dedicated team has developed a high-quality fund management app for iOS users.",
        resultsPoints1: [
  ...
  },
  {
    ...
    details: {
      ...
      regularTitle: 'Convenient Account Management App For Professional Accounting Solutions',
      heroInfo: [
          {
            icon: '/uploads/users.svg',
            alt: 'Developers',
          ...
          },
          {
            ...
            numberOfMonths: 8,
            title: 'MONTHS',
            subtitle: 'The total duration of the development timeline was 8 months.',
        }
      ],
      overviewParagraphs: [
      ...
      solution: {
        description: "Our skilled developers use cutting-edge tools like Node.js, Python, and React to build this flexible and adaptable software.",
        solutionsPoints1: [
      ...
      keyFeature: {
        description: "Cloud accounting is an ideal accounting software platform for a service-based small business since it offers many features to potential consumers.",
        keyFeaturesPoints1: [
      ...
      result: {
        description:"Our specialists developed Cloud Accounting as the optimal answer for handling any sales account. Cloud accounting is a comprehensive business management software that helps the user manage everyday tasks, and lets business owners see the complete picture of the work progress. Everything related to accounting can be done in Cloud Accounting, from setting up multiple vendors to juggling various bank accounts.",
        resultsPoints1: [
    ...
    details: {
      ...
      heroInfo: [
          ...
          },
          {
            ...
            numberOfMonths: 2,
            title: 'MONTHS',
            subtitle: 'The total duration of the development timeline was 2 months.',
        }
      ],
      overviewParagraphs: [
      ...
      keyFeature: {
        description: "Voom Now is an online voice recorder that can record high-quality MP3 sounds directly in a browser. It’s simple to use and allows users to capture audio using either an internal or external microphone. After that, users can download and share the audio recording in any format.",
        keyFeaturesPoints1: [
      ...
      result: {
        description:"Voom Now is a no-frills voice recorder for online use. The ease of use is a point of pride for Voom Now. There are only three easy steps involved in using this simple tool. To begin recording, users press the red button; once finished, they can play back their clip, save it, and even share it with others. There is no limit on the number of times a user can record and no waiting for the file to upload.",
        resultsPoints1: [
    ...
    details: {
      ...
      heroInfo: [
          ...
          },
          {
            ...
            numberOfMonths: 7,
            title: 'MONTHS',
            subtitle: 'The total duration of the development timeline was 7 months.',
        }
      ],
      overviewParagraphs: [
      ...
      keyFeature: {
        description: "Our top-class developers built this fantastic app to help Muslims to perform daily rituals such as reading the Holy Quran, Knowing the exact timing of prayers, using Asma e Husna with translation, using an accurate Qibla locator, and connecting with a large dua community.",
        keyFeaturesPoints1: [
      ...
      result: {
        description:"Quran Touch is the world’s first fully-featured class app. It has many features and facilities that make it easy for users to read the Quran and do other religious tasks.",
        resultsPoints1: [
